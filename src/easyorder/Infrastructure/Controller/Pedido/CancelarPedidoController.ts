...
import { CancelarPedidoUsecase } from "../../../Core/Usecase/Pedidos/CancelarPedidoUsecase";
...
export class CancelarPedidoController {
  ...
  public async handle(req: Request, res: Response): Promise<void> {
    /**
            ...
            #swagger.description = 'Controller para cancelamento de um pedido'
        ...
        */
    try {
      const usecase = new CancelarPedidoUsecase(this.pedidoGateway);
