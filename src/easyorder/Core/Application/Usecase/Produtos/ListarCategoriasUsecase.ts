import { ListaCategoriasUsecaseInput, ListaCategoriasUsecaseOutput } from '../../../Domain/Output/Repository/CategoriaRepositoryInterface';
import { CategoriaEnum } from '../../../Domain/ValueObject/CategoriaEnum';

export class ListarCategoriasUsecase {
    public async execute(input: ListaCategoriasUsecaseInput): Promise<ListaCategoriasUsecaseOutput> {
        try {
